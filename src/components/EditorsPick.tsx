...
const EditorsPick = () => {
  ...
  const projects: ProjectItem[] = [
    ...
    },
    {
      ...
      category: 'SAAS',
      status: 'LIVE',
      excerpt: 'Scoutr monitors top freelance platforms in real-time so freelancers and professionals can pitch first and win more clients.',
      image: '/scoutr.PNG',
      url: 'https://scoutr.gravitas.uno',
      tech: ['React', 'Real-time', 'API Integration'],
    },
    {
      id: '5',
      title: 'YUTE',
